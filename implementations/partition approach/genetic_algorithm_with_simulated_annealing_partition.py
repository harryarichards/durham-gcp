...
def anneal(child):
    ...
    stopping_temperature = 40
    current_colouring = copy.deepcopy(child)
...
if __name__ == "__main__":
    ...
    draw_graph(None)
    initial_upper_bound = max(nx.coloring.greedy_color(graph, strategy='DSATUR').values()) + 1
